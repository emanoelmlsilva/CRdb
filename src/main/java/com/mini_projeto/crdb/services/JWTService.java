...
public class JWTService {
    ...
    public static final String TOKEN_KEY = "project_crdb";

    @Autowired
    private UserRepository userRepository;

    public LoginResponse authentication(UserLoginDTO userLoginDTO) {
        System.out.println("entrou authrntiation");
    ...
    private Optional<String> recoverUser(String headerAuthorization) {
